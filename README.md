...
```
## ADD task in your_leetcode_repo_directory/.vscode/launch.json
```json
{
    "tasks": [
        {
...
```
your_leetcode_repo_directory/.vscode/launch.json
```json
{
...
```
your_leetcode_repo_directory/.vscode/snippets.leetcode.code-snippets
```
{
	"Debug template": {
		"scope": "cpp",
